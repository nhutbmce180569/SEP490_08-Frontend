...
const content: Record<Locale, Record<string, InfoContent>> = {
  vi: {
    ...
    contact: {
      ...
      subtitle: "Kênh liên hệ chính thức của hệ thống StayHub tại Trường Đại học FPT Cần Thơ.",
      cards: [
        { title: "Email hệ thống", body: CONTACT_EMAIL, href: `mailto:${CONTACT_EMAIL}` },
        { title: "Địa chỉ", body: "Trường Đại học FPT Cần Thơ, 600 Nguyễn Văn Cừ nối dài, phường An Bình, TP. Cần Thơ.", href: MAP_LINK },
  ...
  en: {
    ...
    contact: {
      ...
      subtitle: "Official StayHub contact information at FPT University Can Tho.",
      cards: [
        { title: "System email", body: CONTACT_EMAIL, href: `mailto:${CONTACT_EMAIL}` },
        { title: "Address", body: "FPT University Can Tho, 600 Nguyen Van Cu extended, An Binh Ward, Can Tho City.", href: MAP_LINK },
