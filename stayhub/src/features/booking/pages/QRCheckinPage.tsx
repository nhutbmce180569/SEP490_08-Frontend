        ...
        <div className="md:col-span-3 flex flex-col gap-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mb-6 flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                <h1 className="text-xl font-black text-slate-900 flex items-center gap-2">
                  <ScanLine className="h-6 w-6 text-[#0068E0]" /> Ticket Check-In
                </h1>
            ...
            <div className="mb-6 flex rounded-xl bg-slate-100 p-1">
              ...
              >
                <QrCode className="h-4 w-4" /> Camera Scan
              </button>
              <button
              ...
              <div className="relative aspect-square w-full max-w-sm mx-auto overflow-hidden rounded-2xl bg-slate-900 border-4 border-slate-800 shadow-inner">
                ...
                {isProcessing && (
                  <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm flex flex-col items-center justify-center z-10">
                    ...
                    <p className="text-white font-semibold text-sm animate-pulse">Processing ticket...</p>
                  </div>
                )}
            ...
            {scanMode === "manual" && (
              <form onSubmit={handleManualSubmit} className="max-w-sm mx-auto mt-4 space-y-4">
                ...
                >
                  {isProcessing ? <Loader2 className="h-5 w-5 animate-spin" /> : "Process Check-in"}
                </ActionButton>
              </form>
            )}
          </div>
        ...
        <div className="md:col-span-2">
          <div className="sticky top-24 rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden flex flex-col h-[400px]">
            <div className="bg-slate-50 border-b border-slate-100 px-5 py-4">
              <h3 className="font-bold text-slate-800">Scan Result</h3>
            </div>
            ...
            <div className="flex-1 p-5 flex flex-col items-center justify-center text-center bg-slate-50/30">
              {!lastResult ? (
                ...
                <div className="w-full animate-in zoom-in-95 duration-300">
                  ...
                  <h4 className="text-xl font-black text-slate-900 mb-1">Check-in Valid!</h4>
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white p-4 text-left space-y-4 shadow-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Customer Name</p>
                        <p className="truncate font-bold text-slate-900 text-base">
                          {lastResult.ticketData?.customerName || "Anonymous"}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Ticket ID</p>
                        <p className="truncate font-bold text-slate-900 text-base">
                          #{lastResult.ticketData?.id || "N/A"}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="w-full animate-in zoom-in-95 duration-300">
                  ...
                  <h4 className="text-xl font-black text-slate-900 mb-2">Invalid Ticket</h4>
