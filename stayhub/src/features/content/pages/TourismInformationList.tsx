      ...
      <div className="grid gap-3 border-b border-slate-100 px-6 py-4 md:grid-cols-2 xl:grid-cols-5">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm outline-none transition-colors focus:border-[#EB662B] focus:bg-white focus:ring-4 focus:ring-[#EB662B]/10"
          />
          {hasActiveFilters && (
