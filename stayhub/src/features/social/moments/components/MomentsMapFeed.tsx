                  ...
                  {showHeatmap && (
                    <div className="mt-1.5 flex gap-1.5 px-4 pb-2">
                      <button
                        ...
                        className={`flex-1 py-1.5 px-2 rounded-xl text-[11px] font-bold transition-all border ${heatmapType === 'online'
                      ...
                      <button
                        ...
                        className={`flex-1 py-1.5 px-2 rounded-xl text-[11px] font-bold transition-all border ${heatmapType === 'moments'
                            ? 'bg-orange-50 border-orange-200 text-orange-600 shadow-sm'
                            : 'bg-slate-50 border-slate-100 text-slate-500 hover:bg-slate-100/50'
                          }`}
                      >
