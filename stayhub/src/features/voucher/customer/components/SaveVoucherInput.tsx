  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-brand/20 bg-gradient-to-r from-blue-50 via-white to-amber-50 p-5 shadow-sm">
      <div className="mb-4 flex items-start gap-3">
        ...
        <div>
          <h3 className="text-base font-bold text-slate-900">{t('voucher.enterVoucherCode')}</h3>
          <p className="mt-0.5 text-sm text-slate-500">{t('voucher.saveVoucherHint')}</p>
        </div>
      </div>
