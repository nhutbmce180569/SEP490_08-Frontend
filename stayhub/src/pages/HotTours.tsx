  ...
  useEffect(() => {
    const fetchHotTours = async () => {
      try {
        ...
        const res = await apiClient.get<any>(TOURS_API.GET_HOT_TOURS, {
        ...
        setError(err.message || "Failed to fetch hot tours");
      } finally {
        setIsLoading(false);
      }
    };
      ...
      <div className="mx-auto max-w-7xl pb-24 sm:px-6 lg:px-8 mt-4 lg:mt-8">
        <div className="mb-8 flex flex-col gap-2">
          <div className="flex items-center gap-2 text-sm font-semibold text-rose-500 uppercase tracking-widest">
            ...
            {t("home.topPicksEyebrow")}
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
            {t("home.topHotToursTitle") || "Top Hot Tours"}
          </h1>
          <p className="text-slate-600 max-w-2xl">
            {t("home.top5HotToursSubtitle")}
          </p>
        </div>
