...
import { buildScheduleTicketPayload, formatTicketCurrency } from "../utils/tourScheduleTicket";
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="mb-6 flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900">{t("tour.addScheduleTicket")}</h1>
          <p className="mt-1 text-sm font-medium text-slate-500">
            {t("tour.createScheduleTicketDesc", {
              id: scheduleId,
